...
with dag:
  ...
  BACKUP_DB_S3 = SSHOperator(task_id='backup_db',
  ...
  START >> SUMMARIZE_DATACUBE
  SUMMARIZE_DATACUBE >> BACKUP_DB_S3
  BACKUP_DB_S3 >> RESTORE_RDS_S3
  RESTORE_RDS_S3 >> AUDIT_EXPLORER
